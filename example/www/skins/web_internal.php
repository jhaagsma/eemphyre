...
---------------------------------------------------*/
	...
	global $debug;
	$debug_info = null;
	if($debug || $user->administrator){
		include_once("./templates/debug_info.php");
		$debug_info = debug_info($size);
	}
	
	$greeting = "Greetings <span style='color:red'>" . $user->displayname . "</span>!";
/////////////// NOW DO THE HTML////////////////////
?>
...
<body>
	<div id='top_bit'>
		<?php echo $greeting; ?>
		<p>This is the empiresPHPframework example website, internal area!</p>
